...
int	main(void)
{
	...
	i = printf("Testing %c character", 'A');
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Special chars: %c%c%c%c", '!', '@', '#', '$');
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Multiple %c and %c with text %c between %c", 'A', 'B', 'C', 'D');
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Testing %s string", "42 Porto");
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Multiple strings: %s %s %s", "first", "second", "third");
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Mix with text: %s between %s", "string1", "string2");
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Pointer to string: %p", (void *)str);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Pointer to array: %p", (int *)arr);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Positive integer: %d", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Negative integer: %d", -42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Multiple integers: %d %d %d", 1, -1, 0);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Mix with text: %d is the answer", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Positive unsigned integer: %u", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Multiple unsigned integers: %u %u %u", 1, 2, 3);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Mix with text: %u is the answer", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Positive unsigned integer in hex: %x", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Maximum unsigned int in hex: %x", UINT_MAX);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Small unsigned integer in hex: %x", 1);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Multiple unsigned integers in hex: %x %x %x", 1, 2, 3);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Percent with text: %% is the percent sign");
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Precision for string: %.5s", "42 Porto");
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Left-justified INT_MIN: %-d", INT_MIN);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Left-aligned string with width 20: %-20s", "Hello");
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Left-aligned integer with width 10: %-10d", 123);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Zero padded positive integer: %04d", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Zero padded maximum int: %04d", INT_MAX);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Zero padded minimum int: %04d", INT_MIN);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Zero padded multiple integers: %04d %04d %04d", 1, 23, 456);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Zero padded with leading zeros: %05d", 7);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Zero padded with leading zeros: %05d", 12345);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Integer with precision 2: %.2i", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Integer with precision 4: %.4i", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Integer with precision 0: %.0i", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Negative Integer with precision 3: %.3i", -42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("String with precision 5: %.5s", "42 Porto");
	printf("> (return: %i)\n\n", i);
	...
	i = printf("String with precision 3: %.3s", "42 Porto");
	printf("> (return: %i)\n\n", i);
	...
	i = printf("String with precision 0: %.0s", "42 Porto");
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Empty string with precision 5: %.5s", "");
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Hexadecimal with # flag: %#x", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Positive integer with + flag: %+d", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Negative integer with + flag: %+d", -42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Positive integer with + flag: %+i", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Negative integer with + flag: %+i", -42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Positive integer with space flag: % d", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Negative integer with space flag: % d", -42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Positive integer with space flag: % i", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Negative integer with space flag: % i", -42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Hexadecimal with # and + flag: %#x", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Positive integer with + and space flag: %+ d", 42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Negative integer with + and space flag: %+ d", -42);
	printf("> (return: %i)\n\n", i);
	...
	i = printf("Hexadecimal with # and space flag: %#x", 0);
	printf("> (return: %i)\n\n", i);
